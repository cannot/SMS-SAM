...
class NotificationController extends Controller
{
    ...
    public function show($uuid)
    {
        ...
        // Delivery statistics - ใช้ delivered แทน sent
        ...
        // Performance metrics - แก้ไข status เป็น delivered/sent
        $metrics = [
     ...
     */
    public function resendLog(Notification $notification, NotificationLog $log)
    {
        try {
