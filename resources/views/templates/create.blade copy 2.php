                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="small">
                                        <div class="mb-2">
                                            <strong>Template Naming:</strong> Use descriptive names that indicate the purpose and audience.
                                        </div>
                                        <div class="mb-2">
                                            <strong>Subject Lines:</strong> Keep them concise and action-oriented. Use variables for personalization.
                                        </div>
                                        <div class="mb-2">
                                            <strong>HTML Content:</strong> Use inline CSS for better email client compatibility.
                                        </div>
                                        <div class="mb-2">
                                            <strong>Text Version:</strong> Always provide a plain text version for accessibility and SMS.
                                        </div>
                                        <div class="mb-2">
                                            <strong>Variables:</strong> Test with sample data to ensure proper rendering.
                                        </div>
                                        <div class="mb-0">
                                            <strong>Testing:</strong> Use the preview feature to validate your template before saving.
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="{{ asset('js/template-create.js') }}" defer></script>
