                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="3" placeholder="อธิบายวัตถุประสงค์หรือเงื่อนไขของกลุ่มนี้">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('webhook_url') is-invalid @enderror" id="webhook_url" name="webhook_url"
                                    rows="3" placeholder="https://example.com/webhook">{{ old('webhook_url') }}</textarea>
                                @error('webhook_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div id="departmentSection" class="mb-3" style="display: none;">
                                ...
                                <select class="form-select" id="department" name="criteria[department]">
                                    ...
                                    @foreach ($departments as $dept)
                                        <option value="{{ $dept }}"
                                            {{ old('criteria.department') === $dept ? 'selected' : '' }}>
                                            {{ $dept }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" id="ldap_group" name="criteria[ldap_group]">
                                    ...
                                    @foreach ($ldapGroups as $ldapGroup)
                                        <option value="{{ $ldapGroup }}"
                                            {{ old('criteria.ldap_group') === $ldapGroup ? 'selected' : '' }}>
                                            {{ $ldapGroup }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div id="roleSection" class="mb-3" style="display: none;">
                                ...
                                <input type="text" class="form-control" id="title" name="criteria[title]"
                                    value="{{ old('criteria.title') }}" placeholder="เช่น Manager, Developer, Admin">
                                <div class="form-text">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="dynamic_title"
                                                name="criteria[title]" value="{{ old('criteria.title') }}"
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <button type="button" class="btn btn-info" onclick="previewMembers()" id="previewBtn"
                                    style="display: none;">
                        ...
                        <div class="card-body">
                            <div class="accordion" id="helpAccordion">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#manualHelp">
                                            <i class="bi bi-hand-index me-2"></i>กำหนดเอง (Manual)
                                        </button>
                                    </h2>
                                    <div id="manualHelp" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#departmentHelp">
                                            <i class="bi bi-building me-2"></i>แผนก (Department)
                                        </button>
                                    </h2>
                                    <div id="departmentHelp" class="accordion-collapse collapse"
                                        data-bs-parent="#helpAccordion">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#ldapHelp">
                                            <i class="bi bi-diagram-3 me-2"></i>LDAP Group
                                        </button>
                                    </h2>
                                    <div id="ldapHelp" class="accordion-collapse collapse"
                                        data-bs-parent="#helpAccordion">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#dynamicHelp">
                                            <i class="bi bi-gear me-2"></i>Dynamic
                                        </button>
                                    </h2>
                                    <div id="dynamicHelp" class="accordion-collapse collapse"
                                        data-bs-parent="#helpAccordion">
                                        <div class="accordion-body">
