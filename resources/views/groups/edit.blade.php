                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="อธิบายวัตถุประสงค์หรือเงื่อนไขของกลุ่มนี้">{{ old('description', $group->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                ...
                                <option value="department" {{ old('type', $group->type) === 'department' ? 'selected' : '' }}>
                                    แผนก (Department) - อิงจากแผนกใน LDAP
                                </option>
                                <option value="role" {{ old('type', $group->type) === 'role' ? 'selected' : '' }}>
                                    ตำแหน่ง (Role) - อิงจากตำแหน่งงาน
                                </option>
                                <option value="ldap_group" {{ old('type', $group->type) === 'ldap_group' ? 'selected' : '' }}>
                                    LDAP Group - อิงจากกลุ่มใน LDAP
                                </option>
                                <option value="dynamic" {{ old('type', $group->type) === 'dynamic' ? 'selected' : '' }}>
