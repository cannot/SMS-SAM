...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">สร้างบทบาทใหม่</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="name" class="form-label">ชื่อระบบ <span class="text-danger">*</span></label>
                            <input type="text" 
                                   ...
                                   required>
                            <div class="form-text">ใช้ภาษาอังกฤษ ตัวพิมพ์เล็ก และขีดกลาง</div>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="คำอธิบายเกี่ยวกับบทบาทนี้">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle me-1"></i> สร้างบทบาท
                            </button>
                            <a href="{{ route('roles.index') }}" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <span class="badge bg-success me-2" id="selected-count">0 สิทธิ์ที่เลือก</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ms-auto">
                                    <span class="badge bg-info me-2" data-group-counter="{{ $module }}">0/{{ $groupPermissions->count() }}</span>
                                    <button type="button" 
